<html>
    ...
    <body>
        <div class="flex justify-center md:justify-end md:pr-40 pt-10">
            <form action="<?php echo e(route('login')); ?>" method="post" class="border border-green-500 rounded-2xl md:w-80 md:h-100">'
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH G:\website\copypaste\resources\views/login.blade.php ENDPATH**/ ?>